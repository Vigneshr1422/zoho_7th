...
👉 Quick Problem_Solving.search by name.

List irundhaalum, oru employee name ku Problem_Solving.search panna full loop pannanum (O(n)).
...
So nameToEmp map is just for fast lookup by employee name, nothing else. ✅
    ...
    // Flexible Problem_Solving.search
